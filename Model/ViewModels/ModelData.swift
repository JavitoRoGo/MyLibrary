...
struct EBooks: Codable, Identifiable, Equatable, BooksProtocol {
    ...
    static let dataTest = EBooks(id: 0, author: "Pepito Pérez", bookTitle: "Título del ebook", originalTitle: "Título original", year: 2022, pages: 666, price: 9.99, owner: "Yo", status: .consulting, synopsis: "Resumen de prueba.", cover: "cover001")
}
